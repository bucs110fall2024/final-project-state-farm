...
from src.struggle.game import Game
from src.struggle.ship import Ship
from src.struggle.asteroid import Asteroid
from src.struggle.sound import Sound
from src.struggle.timer import Timer
from src.struggle.menu import Menu, MainMenu
...
class Controller:
    ...
    def main_menu_loop(self):
        while self.menu.menu_open == True:
            self.check_events()
            if self.state != "menu":
